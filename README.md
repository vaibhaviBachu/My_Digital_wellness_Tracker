...
##  Project Objectives
- To analyze digital usage and wellness-related data  
- To visualize daily and weekly digital behavior trends  
- To identify excessive screen time and unhealthy patterns  
- To promote mindful and balanced digital usage  
- To demonstrate effective use of Tableau for data analytics  
...
###  Data Visualization
- **Tableau Desktop** – Dashboard creation and interactive analytics  

###  Data Source
- **CSV / Excel Files** – Digital wellness datasets  
- **Data Cleaning & Preparation** – Performed prior to visualization  

###  Version Control & Documentation
- **Git & GitHub** – Repository management and documentation  
